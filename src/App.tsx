...
export default function App() {
  ...
  const renderFooter = () => (
    <footer className="relative z-10 border-t border-white/20 pt-16 pb-8 px-4 md:px-8 bg-white/5 backdrop-blur-md mt-auto">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8 border-b border-white/10 pb-12">
        <div className="text-center md:text-left">
          <div className="font-sans font-semibold text-2xl text-white tracking-tight mb-3">CampBridge</div>
          <p className="text-white/60 text-sm font-medium">The operating system for campus marketing.</p>
        </div>
        <div className="flex flex-col items-center md:items-end gap-4">
          <div className="flex gap-8 text-sm font-bold text-white/80 uppercase tracking-widest text-center">
            <span onClick={() => setCurrentView('partners')} className="hover:text-white transition-colors cursor-pointer">Contact</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="https://github.com/kaif-builds" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/alkaif-gajdhar-b6033328b" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
          </div>
        </div>
      </div>
      <div className="max-w-6xl mx-auto mt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-white/40">
        <div>© {new Date().getFullYear()} CampBridge Inc. All rights reserved.</div>
    ...
    <>
      ...
      <section className="relative z-10 px-4 md:px-8 max-w-5xl mx-auto mb-16">
         <div className="bg-[#1D2B5D] border border-white/20 rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
               <h2 className="font-serif text-[2.2rem] md:text-[3rem] text-white mb-4 leading-tight">Ready to Transform<br/>Your Campus Presence?</h2>
               <p className="text-white/80 font-medium text-[16px] max-w-xl mx-auto mb-10 leading-relaxed">Join 50+ brands and 500+ ambassadors already growing on CampBridge.</p>
               <button onClick={() => setCurrentView('choose-role')} className="bg-white text-[#1D2B5D] px-10 py-4 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1">Get Started Free</button>
            </div>
         </div>
      </section>
